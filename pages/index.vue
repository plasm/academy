<template>
  <div class="mx-auto px-4 sm:px-6 md:px-8 2xl:max-w-7xl">
    <div class="gradient py-10">
      <ac-heading description="Con AIGES Academy, acquisisci il know-how avanzato per padroneggiare la gestione del conflitto familiare.">
        <template #title>
...
.gradient{
  background: radial-gradient(50.9% 35.5% at 50% 38%, rgba(200, 200, 255, .16) 0%, #17171700 100%);
}</style>
