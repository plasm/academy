    ...
    <section>
      <div class="mx-auto w-full max-w-7xl items-center px-5 py-12 md:px-12 lg:px-16">
        <ul role="list" class="space-y-12 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 sm:space-y-0 lg:grid-cols-2 lg:gap-x-8">
          <li>
            <ac-user-card title="Fabrizio Dell'Anna" role="Role" image="https://images.unsplash.com/flagged/photo-1570612861542-284f4c12e75f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80" />
          </li>
          <li>
            <ac-user-card title="Manuela Pagliaroli" role="Role" image="https://images.unsplash.com/photo-1602434228300-a645bce6891b?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1639&amp;q=80" />
          </li>
        </ul>
      </div>
    </section>
