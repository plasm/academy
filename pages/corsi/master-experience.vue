  ...
  <div data-name="page-master-experience" class="mt-24">
    ...
    <div class="mx-auto max-w-5xl px-6 py-10 md:p-20 md:pt-0">
      <div class="mb-8 flex flex-col gap-4 text-lg font-light text-white md:text-2xl">
        <div>
          Il <span class="text-gold">Master Experience in Mediazione familiare</span> di AIGES Academy è un <u>corso di qualifica professionale</u>, destinato ad avvocati, praticanti abilitati, psichiatri, psicologi, assistenti sociali, coordinatori genitoriali, counselor, pedagogisti, educatori, criminologi, sociologi e laureati in area umanistica, sanitaria e/o sociale.
        </div>
        <div>
