<template>
  <div data-name="page-alta-formazione">
    ...
    <div class="mx-auto max-w-6xl  px-4">
      ...
      <br>
      <div class="text-white">
        Toolkit professionale con gli strumenti di lavoro per lo svolgimento del processo di coordinazione genitoriale.
      </div>
      <br>
